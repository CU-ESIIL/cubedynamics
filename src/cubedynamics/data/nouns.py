    ...
    attrs.update(
        {
            ...
            "temporal_support_type": definition["temporal_support_type"],
            "temporal_label_convention": definition["temporal_label_convention"],
            "temporal_reference_timezone": definition["temporal_reference_timezone"],
            "temporal_support_start_offset": definition["temporal_support_start_offset"],
            "temporal_support_end_offset": definition["temporal_support_end_offset"],
            "temporal_support_known": int(definition["temporal_support_known"]),
            "temporal_support_evidence": definition["temporal_support_evidence"],
