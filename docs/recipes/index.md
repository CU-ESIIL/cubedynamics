...
| [Local climate-tail synchrony](spatial_synchrony_signature.md) | Canonical pairs, local surfaces, fixed summaries, finite-range diagnostics, continuous decay, masks/halos, and landscape change |
