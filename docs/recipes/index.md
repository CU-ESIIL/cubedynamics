...
You will find:
- A recipe template for new analyses.
- Example workflows across climate variance, NDVI, and synchrony analyses.
- Pointers to visualization tools that close the loop on interpretation.
...
- If you want workflows: [Recipes Overview](index.md)
