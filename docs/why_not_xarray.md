# Why CubeDynamics Exists (Even If You Use xarray)

CubeDynamics is built on top of the xarray and dask ecosystem. Many workflows can be accomplished directly with xarray alone. This project exists to provide an explicit grammar for spatiotemporal analysis, guardrails for reproducibility, and streaming-first defaults.
