...
This page orients you to Climate Cube Math in a single view. Use the cards below to jump into the sections that match your goal.
...
<div class="ccm-card-grid">
  ...
  <a class="ccm-card" href="capabilities/">
    <div class="ccm-card-title">Capabilities &amp; Verbs</div>
  ...
  <a class="ccm-card" href="datasets/">
    ...
    <div class="ccm-card-text">Find supported sources and their spatial and temporal semantics.</div>
  </a>
  <a class="ccm-card" href="howto/">
  ...
  <a class="ccm-card" href="api/">
    <div class="ccm-card-title">API Reference</div>
    <div class="ccm-card-text">Explore detailed docstrings and parameters for CubeDynamics classes and verbs.</div>
  </a>
  <a class="ccm-card" href="dev/contributing/">
    <div class="ccm-card-title">Contributing / Development</div>
    <div class="ccm-card-text">Review contribution guidelines, project scope, and development notes.</div>
  </a>
</div>

Use this as a hub alongside the sidebar navigation when you are unsure where to go next.
