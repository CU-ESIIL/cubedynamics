...
v.zscore(dim='time', *, over=None, keep_dim=True, std_eps=0.0001, skipna=True)
```
...
| std_eps | See implementation docstring below; no parameter-specific description supplied. | 0.0001 |
...
result = (pipe(cube) | v.zscore(dim="time")).unwrap()
...
[Implementation source](https://github.com/CU-ESIIL/cubedynamics/blob/main/src/cubedynamics/verbs/stats.py#L381). Signatures and descriptions on this page are generated from this checkout, not hand-maintained copies.
