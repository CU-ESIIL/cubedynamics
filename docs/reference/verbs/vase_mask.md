...
v.vase_mask(cube, vase, time_dim='time', y_dim='y', x_dim='x')
```
...
[Implementation source](https://github.com/CU-ESIIL/cubedynamics/blob/main/src/cubedynamics/verbs/vase.py#L12). Signatures and descriptions on this page are generated from this checkout, not hand-maintained copies.
