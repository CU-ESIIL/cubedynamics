...
[Interactive cube viewer](viz/cube_viewer.md) page for controls, HTML export, and interactivity troubleshooting.
...
- [Interactive cube viewer](viz/cube_viewer.md) collects controls, saving/debug tips, and developer invariants for `v.plot()`.
- [Virtual Cubes](concepts/virtual_cubes.md) explains the tiling model and shows more code.
